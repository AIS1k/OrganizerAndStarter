...
def playMySound(file):
    winsound.PlaySound(f'sounds\{file}', winsound.SND_ASYNC)
...
class Picker(Generic[OPTION_T]):
    ...
    def get_option_lines(self) -> List[str]:
        ...
        for index, option in enumerate(self.options):
            ...
            lines.append(f"{prefix} {option_as_str} {end_prefix}")
    ...
    def draw(self, screen: "curses._CursesWindow") -> None:
        ...
        for line in lines_to_draw:
            ...
            if y == current_line:
                screen.addnstr(y, x, line, max_x - 2, curses.A_STANDOUT)
            else:
